...
- DSNS/DSNL: Natural Sciences with Lab (satisfied by major)
...
def test_cs_major_general_track_full_schedule():
    ...
    major_reqs = MajorRequirements(
        ...
        upper_level=[
            ...
            Requirement(
                ...
                type=RequirementType.GROUP,
                name="CS Upper Level Electives",
                courses=[
                    "CMSC411", "CMSC412", "CMSC414", "CMSC421", 
                    "CMSC422", "CMSC423", "CMSC424", "CMSC425",
                    "CMSC426", "CMSC427", "CMSC430", "CMSC433",
                    "CMSC434", "CMSC435", "CMSC456"
                ],
                min_credits=39,  # 13 courses @ 3 credits each
                min_courses=13
            )
        ],
        supporting_courses=[
    ...
    # Upper level CS core
    upper_core_required = {"CMSC330", "CMSC351", "CMSC420"}
    upper_core_scheduled = upper_core_required & all_scheduled_courses
    print(f"\nCS Upper Level Core (3 required):")
    ...
    gened_requirements = {
        ...
        'DSNS': {'name': 'Natural Sciences', 'min_credits': 6, 'min_courses': 2},
        'DSNL': {'name': 'Natural Sciences Lab', 'min_credits': 1, 'min_courses': 1},
    ...
    assert len(upper_core_scheduled) == 3, f"Expected 3 upper core CS courses, got {len(upper_core_scheduled)}"
    print("✓ All 3 upper level CS core courses scheduled")
